...
export default function Nav({ dict }: NavProps) {
  ...
  // ✅ Detectează limba corect + fallback
  const currentLang: Lang = useMemo(() => {
    const seg1 = pathname.split("/")[1];
    return seg1 === "ro" || seg1 === "it" ? seg1 : "ro";
  }, [pathname]);
  ...
  const handleBurger = () => setIsBurgerOpen((prev) => !prev);
          ...
          <div className="px-6 py-4 flex items-center justify-between gap-8">
            {isScrolled && isMobile ? (
              <Button variant="primary">
                {/* ⚠️ aici ai /shop, dar jos ai /buy-tim – păstrează consistent */}
